...
<html>
	<head>
		...
		<link href="/resources/css/jquery-ui.min.css" rel="stylesheet" media="all">
	...
	<body class="body">
		...
		<div class="container" id="menu_before_scroll">
		<!-- The justified navigation menu is meant for single line per list item.
           Multiple lines will require custom code not provided by Bootstrap. -->
			  <div class="masthead">
				<h3 class="text-muted">Interest Calculator</h3>
				<nav>
				  <ul class="nav nav-justified">
					<li id="homeLi" class="active"><a data-toggle="pill" onclick="redirect('');" href="#">Home</a></li>
					<li id="addUserLi"><a data-toggle="pill" onclick="javascript:redirect('addUser');" href="#">Add User</a></li>
					<li><a data-toggle="pill" href="#">Services</a></li>
					<li><a data-toggle="pill" href="#">Downloads</a></li>
		...
		<script src="/resources/js/swagger-ui-bundle.js"></script>
		<script src="/resources/js/swagger-ui-standalone-preset.js"></script>
		<script src="/resources/js/swagger-ui.js"></script>
...
<script>
	function redirect(url) {		
		doGet('/'+url,{	renderTo:'containerBody' });		
	}	
</script>